...
const RoadNotTaken = () => {
  ...
  return (
    <div className="w-full max-w-2xl border rounded-lg p-4 bg-white shadow-lg">
        ...
        {manualMode && (
          <div className="flex gap-4">
            <button
              ...
              disabled={gameOver}
              className="w-24 bg-blue-500 text-white p-2 rounded hover:bg-blue-600 disabled:opacity-50"
            >
              Left
            </button>
            <button
            ...
            {gameOver && (
              <button 
                onClick={resetGame}
                className="w-24 bg-green-500 text-white p-2 rounded hover:bg-green-600"
              >
                Reset
              </button>
            )}
